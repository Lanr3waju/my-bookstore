...
function Header({ isDark, handleIsDark }) {
    return (
        <header className={isDark ? "bg-slate-900 text-white shadow-md shadow-gray-400 p-4 items-center flex" : "p-4 items-center text-gray-700 flex shadow-md shadow-slate-800"}>
