...
describe('AddBook', () => {
    ...
    it('disables button when input fields are filled with incorrect values or data type', () => {
        ...
        fireEvent.change(screen.getByTestId('title'), { target: { value: 'JS For Dummies' } });
        fireEvent.change(screen.getByTestId('author'), { target: { value: 'Abass' } });
        fireEvent.change(screen.getByTestId('chapters'), { target: { value: 'thirty' } });
        expect(submit).toBeDisabled();
    ...
    it('enables button when input fields are filled with correct values', () => {
        ...
        fireEvent.change(screen.getByTestId('title'), { target: { value: 'React for dummies' } });
        fireEvent.change(screen.getByTestId('author'), { target: { value: 'Olanrewaju' } });
